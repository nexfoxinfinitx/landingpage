...
export function initServices() {
  ...
  const menuItems = document.querySelectorAll('#services-menu .menu__item');
  ...
  menuItems.forEach((item) => {
    ...
    setTimeout(setupMarquee, 500); // Increased slightly for single scroll
